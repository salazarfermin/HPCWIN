...
#New-AzureRmResourceGroupDeployment -Name hpc-ctest -ResourceGroupName $ResourceGroupName -TemplateFile (Join-Path (Split-Path $myinvocation.mycommand.path) 'HPCLinux.json') -Verbose -DeploymentDebugLogLevel All;
